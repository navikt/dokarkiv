...
public class KasserDokumentRestController {
	...
	public ResponseEntity kasserDokument(
		...
		kasserDokumentOrchestrator.kasserDokument(request.getDokumentInfoId(), request.getKassertAvNavn(), hjemmel, bruker, melding,utfoertAv);
	...
	public ResponseEntity kasserSkjermDokument(
		...
		kasserDokumentOrchestrator.kasserSkjermDokument(dokumentInfoId, hjemmel, bruker, melding, utfoertAv);
	...
	public ResponseEntity opphevKasserSkjermDokument(
		...
		kasserDokumentOrchestrator.opphevKasserSkjermDokument(dokumentInfoId, hjemmel, bruker, melding,utfoertAv);
