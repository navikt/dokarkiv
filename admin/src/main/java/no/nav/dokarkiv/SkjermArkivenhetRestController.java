...
public class SkjermArkivenhetRestController {
	...
	public ResponseEntity skjermArkivenhet(
		...
		skjermArkivEnhetOrchestrator.skjermArkivEnhet(skjermArkivenhetRequest, hjemmel, bruker, melding, utfoertAv);
	...
	public ResponseEntity opphevSkjermArkivenhet(
		...
		skjermArkivEnhetOrchestrator.opphevSkjermArkivEnhet(skjermArkivenhetRequest, hjemmel, bruker, melding, utfoertAv);
