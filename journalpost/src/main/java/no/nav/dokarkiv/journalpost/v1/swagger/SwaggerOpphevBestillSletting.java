...
@Documented
@Operation(
	summary = "Opphever en aktiv slettebestilling for et dokument"
)
@ApiResponses(value = {
	@ApiResponse(responseCode = "204", description = "Slettebestillingen ble opphevet"),
	@ApiResponse(responseCode = "400", description = "Slettebestillingen kan ikke oppheves, f.eks. fordi den allerede er ferdigstilt", content = @Content),
