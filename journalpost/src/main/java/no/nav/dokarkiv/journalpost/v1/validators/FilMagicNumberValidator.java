...
public class FilMagicNumberValidator {
	...
	public static boolean isFileContentContainsValidMagicNumber(String fileType, byte[] fileContent) {
	...
	private static boolean isValidJpegMagicNumber(byte[] fileContent) {
	...
	private static boolean isValidPngMagicNumber(byte[] fileContent) {
		return Arrays.equals(copyOf(fileContent, PNG_MAGIC_NUMBER.length), PNG_MAGIC_NUMBER);
	}
	
	private static boolean isValidPdfMagicNumber(byte[] fileContent) {
		return Arrays.equals(copyOf(fileContent, PDF_MAGIC_NUMBER.length), PDF_MAGIC_NUMBER);
	}
}
