...
@Documented
@Operation(
		summary = "Avslutter sak i fagarkivet"
)
@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "OK"),
		@ApiResponse(responseCode = "204", description = "Arkivsaken er allerede avsluttet, avbrutt eller avlevert.", content = @Content),
		@ApiResponse(responseCode = "400", description = "Request feilet validering, eller saken har journalposter under redigering.", content = @Content),
