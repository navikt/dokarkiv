...
public final class JournalStatusCodeConstants {
	public static final List<JournalStatusCode> INNGÅENDE_JOURNAL_STATUS_CODE = Arrays.asList(OD, M, MO, UB);
	public static final List<JournalStatusCode> UTGÅENDE_OR_NOTAT_JOURNAL_STATUS_CODE = Arrays.asList(D, R);
