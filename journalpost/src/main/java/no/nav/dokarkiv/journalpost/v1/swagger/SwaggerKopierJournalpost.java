...
@Documented
@ApiOperation("Kloner journalposten. Den nye journalposten settes i en midlertidig status slik at den kan knyttes til en annen sak/bruker")
@ApiResponses(value = {
		...
		@ApiResponse(code = 403, message = "Bruker mangler tilgang til å kopiere journalpost"),
