...
@ApiResponses(value = {
		@ApiResponse(responseCode = "201", description = "Journalpost kopierte"),
		@ApiResponse(responseCode = "400", description = "Kan ikke kopiere journalpost", content = @Content),
		@ApiResponse(responseCode = "401", description = "Mangler tilgang til å kopiere ny journalpost. Ugyldig OIDC token. Denne feilen gis dersom tokenet ikke har riktig format eller er utgått.", content = @Content),
