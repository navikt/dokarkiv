package no.nav.dokarkiv.oppdatermetadata.v1.util;
...
public class TestUtils {
	...
	public static PutOppdatermetadataRequest createPutOppdaterMetadataRequest() {
	...
	private static no.nav.dok.oppdatermetadata.api.v1.Bruker createBrukerPerson() {
		return no.nav.dok.oppdatermetadata.api.v1.Bruker.builder()
				.brukerIdType(BrukerIdType.FNR)
				.identifikator(BRUKER_ID_PERSON)
				.build();
	}

	private static no.nav.dok.oppdatermetadata.api.v1.Bruker createBrukerOrganisasjon() {
		return no.nav.dok.oppdatermetadata.api.v1.Bruker.builder()
	...
	private static List<no.nav.dok.oppdatermetadata.api.v1.DokumentInfo> createDokumentInfos() {
		return Arrays.asList(
				no.nav.dok.oppdatermetadata.api.v1.DokumentInfo.builder()
						.brevkode(BREVKODE1)
