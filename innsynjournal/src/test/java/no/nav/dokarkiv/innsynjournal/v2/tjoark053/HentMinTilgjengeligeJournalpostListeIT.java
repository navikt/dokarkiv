...
import static no.nav.dokarkiv.innsynjournal.v2.datautil.FildetaljerTestDataProvider.FIL_TYPE;
import static no.nav.dokarkiv.innsynjournal.v2.datautil.FildetaljerTestDataProvider.VARIANT_FORMAT;
import static no.nav.dokarkiv.innsynjournal.v2.datautil.FildetaljerTestDataProvider.createFildetaljer;
import static no.nav.dokarkiv.innsynjournal.v2.datautil.JournalpostDokumentInfoRelasjonTestDataProvider.createHoveddokumentRelasjon;
import static no.nav.dokarkiv.innsynjournal.v2.datautil.JournalpostDokumentInfoRelasjonTestDataProvider.createVedleggRelasjon;
import static no.nav.dokarkiv.innsynjournal.v2.datautil.JournalpostTestDataProvider.FNR;
import static no.nav.dokarkiv.innsynjournal.v2.datautil.JournalpostTestDataProvider.JANUARY_1_2020;
import static no.nav.dokarkiv.innsynjournal.v2.datautil.JournalpostTestDataProvider.JP_AVSENDER_MOTTAKER;
import static no.nav.dokarkiv.innsynjournal.v2.datautil.JournalpostTestDataProvider.JP_FAGOMRADE;
import static no.nav.dokarkiv.innsynjournal.v2.datautil.JournalpostTestDataProvider.JP_TYPE;
import static no.nav.dokarkiv.innsynjournal.v2.datautil.JournalpostTestDataProvider.createJournalpost;
import static no.nav.dokarkiv.innsynjournal.v2.datautil.JournalpostTestDataProvider.createJournalpostWithoutHoveddokument;
import static no.nav.dokarkiv.innsynjournal.v2.datautil.SaksrelasjonTestDataProvider.SAK_FAGSYSTEM;
import static no.nav.dokarkiv.innsynjournal.v2.datautil.SaksrelasjonTestDataProvider.SAK_ID;
...
import no.nav.dokarkiv.innsynjournal.v2.datautil.SkannetInnholdTestDataProvider;
