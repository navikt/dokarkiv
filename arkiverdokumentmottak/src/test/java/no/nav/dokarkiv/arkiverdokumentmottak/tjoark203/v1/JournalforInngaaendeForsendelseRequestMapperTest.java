...
/**
 * Unit test for {@link JournalforInngaaendeForsendelseRequestMapper}
 *
 * @author Leo-Andreas Ervik, Visma Consulting. 21.02.2017
 */
@RunWith(MockitoJUnitRunner.class)
public class JournalforInngaaendeForsendelseRequestMapperTest {
	...
	@InjectMocks
	private JournalforInngaaendeForsendelseRequestMapper mapper;
