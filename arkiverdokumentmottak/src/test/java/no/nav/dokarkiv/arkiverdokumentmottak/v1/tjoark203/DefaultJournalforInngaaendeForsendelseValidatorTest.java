...
import no.nav.dokarkiv.arkiverdokumentmottak.ValidatorConfig;
...
/**
 * Unit test for {@link DefaultJournalforInngaaendeForsendelseValidator}
 *
 * @author Leo-Andreas Ervik, Visma Consulting. 27.02.2017
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = {ValidatorConfig.class})
public class DefaultJournalforInngaaendeForsendelseValidatorTest {
