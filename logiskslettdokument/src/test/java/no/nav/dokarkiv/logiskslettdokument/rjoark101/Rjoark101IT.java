...
import static no.nav.dokarkiv.core.util.TestDataUtils.AKSJON_ANGRE_LOGISK_SLETT;
...
public class Rjoark101IT extends AbstractSlettDokumentIT {
	...
	public void skalLagreAksjonVedLogiskSlett() throws IOException {
		...
		ResponseEntity<LogiskSlettDokumentResponse> responseEntity = restTemplate.exchange(
				...
				HttpMethod.POST,
				new HttpEntity<>(createHeadersWithAksjon(AKSJON_ANGRE_LOGISK_SLETT)),
		...
		assertThat(aksjonsLoggList.get(0).getAksjon(), is(AKSJON_ANGRE_LOGISK_SLETT));
	}
