...
public interface BegrensningRepository extends CrudRepository<Begrensning, Long> {
	...
	Optional<List<Begrensning>> findAllByJournalpostIdAndDokumentInfoIdAndBegrensningType(Long journalpostId, Long dokumentInfoId, BegrensningTypeCode begrensningType);

	Optional<List<Begrensning>> findByJournalpostIdAndBegrensningTypeAndDokumentInfoIdIsNull(@Param("journalpostId") Long journalpostId, @Param("begrensningType") BegrensningTypeCode begrensningType);
}
