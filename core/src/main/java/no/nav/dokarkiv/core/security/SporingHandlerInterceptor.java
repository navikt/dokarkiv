...
import no.nav.dokarkiv.core.security.handler.AzureAdFlowHandler;
...
public class SporingHandlerInterceptor implements HandlerInterceptor {
    ...
    private final AzureAdFlowHandler azureAdFlowHandler;
    ...
    public SporingHandlerInterceptor(TokenValidationContextHolder tokenValidationContextHolder,
        ...
        this.azureAdFlowHandler = new AzureAdFlowHandler();
    ...
    private boolean handleAuthorizedAccess(HttpServletResponse response, Object handler,
        ...
        if (tokenValidationContext.getJwtTokenAsOptional(ISSUER_AZUREV2).isPresent()) {
            ...
            azureAdFlowHandler.handle(tokenValidationContext.getJwtToken(ISSUER_AZUREV2));
