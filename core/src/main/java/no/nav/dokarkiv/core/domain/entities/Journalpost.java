...
public class Journalpost extends AbstractPersistentVersionedDomainObjectWithKilde {
    ...
    public Begrensning getBegrensningnerByJournalpostIdOnly(Journalpost journalpost, BegrensningTypeCode begrensningType) {
        for (Begrensning begrensning : journalpost.getBegrensninger()) {
            if (begrensningType.equals(begrensning.getBegrensningType()) && begrensning.getJournalpost()
                    .equals(journalpost) && begrensning.getDokumentInfo() == null) {
                return begrensning;
            }
        }
        return null;
    ...
    /**
     * Getter for the journalpostDokumentInfoRelasjoner which also includes all "begrenset" documents. This should only be used when necessary
     *
     * @return the journalpostDokumentInfoRelasjoner
     */
    public Set<JournalpostDokumentInfoRelasjon> getJournalpostDokumentInfoRelasjonerAlsoBegrenset() {
