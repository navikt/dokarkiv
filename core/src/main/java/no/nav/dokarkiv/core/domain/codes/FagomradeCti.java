...
/**
 * CodesTableItem representing the T_K_FAGOMRADE DB table.
 *
 * @author Thomas Eugen Bjørge, Sirius IT
 */
@Entity
@Table(name = "T_K_FAGOMRADE")
@AttributeOverrides( { @AttributeOverride(name = "code", column = @Column(name = "k_fagomrade")),
...
public class FagomradeCti extends CodesTablePeriodicItem<FagomradeCode, String> {
