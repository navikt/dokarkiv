CREATE TABLE T_SAK_STATUS (
    ...
    CONSTRAINT FK_T_SAK_STATUS_1 FOREIGN KEY (K_FAGOMRADE) REFERENCES T_K_FAGOMRADE,
    CONSTRAINT FK_T_SAK_STATUS_2 FOREIGN KEY (K_SAK_STATUS) REFERENCES T_K_SAK_STATUS
);
