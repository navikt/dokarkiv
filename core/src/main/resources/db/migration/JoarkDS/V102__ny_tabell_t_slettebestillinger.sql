...
values ('POL', 'Slettebestilling etter personopplysningsloven', systimestamp, 'MMA-8345');
insert into T_K_SLETTEBESTILLING_HJEMMEL (K_SLETTEBESTILLING_HJEMMEL, DEKODE, DATO_OPPRETTET, OPPRETTET_AV)
values ('ARK', 'Slettebestilling etter arkivloven', systimestamp, 'MMA-8345');
...
(
    ...
    constraint FK_T_SLETTEBESTILLING_TYPE foreign key (K_SLETTEBESTILLING_TYPE) references T_K_SLETTEBESTILLING_TYPE (K_SLETTEBESTILLING_TYPE),
    constraint FK_T_SLETTEBESTILLING_STATUS foreign key (K_SLETTEBESTILLING_STATUS) references T_K_SLETTEBESTILLING_STATUS (K_SLETTEBESTILLING_STATUS),
    constraint FK_T_SLETTEBESTILLING_HJEMMEL foreign key (K_SLETTEBESTILLING_HJEMMEL) references T_K_SLETTEBESTILLING_HJEMMEL (K_SLETTEBESTILLING_HJEMMEL),
    constraint FK_T_SLETTEBESTILLING_ARSAK foreign key (K_SLETTEBESTILLING_ARSAK) references T_K_SLETTEBESTILLING_ARSAK (K_SLETTEBESTILLING_ARSAK),
