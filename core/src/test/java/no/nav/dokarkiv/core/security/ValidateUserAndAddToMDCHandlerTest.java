...
@DataLdapTest
@ContextConfiguration(classes = {ValidateUserAndAddToMDCHandlerTest.TestConfig.class, LdapConfig.class, ValidateUserAndAddToMDCHandler.class, NavLdapService.class})
