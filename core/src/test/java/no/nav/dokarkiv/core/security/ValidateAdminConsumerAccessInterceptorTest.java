...
public class ValidateAdminConsumerAccessInterceptorTest {
	...
	private final ValidateAdminConsumerAccessInterceptor validateAdminConsumerAccessInterceptor = new ValidateAdminConsumerAccessInterceptor(azureAdGraphService, "0000-GA-joark-vedlikehold");
