package no.nav.dokarkiv.slettdokument.security;

import static no.nav.dokarkiv.slettdokument.security.SecurityConfig.AZURE_ISSUER_URL;
import static no.nav.dokarkiv.slettdokument.security.SecurityConfig.GOOGLE_ISSUER_URL;
import static no.nav.dokarkiv.slettdokument.security.SecurityConfig.NAV_STS_ISSUER_URL;
import static no.nav.dokarkiv.slettdokument.security.SecurityConfig.OPEN_AM_ISSUER_URL;
