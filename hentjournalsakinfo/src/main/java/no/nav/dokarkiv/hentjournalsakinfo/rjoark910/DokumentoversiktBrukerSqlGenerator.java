 ...
 */
final class DokumentoversiktBrukerSqlGenerator {
	private DokumentoversiktBrukerSqlGenerator() {
		//ikke instansier
	}
	...
	// Spørringen finner journalposter tilknyttet bruker, psak id og midlertidige journalposter.
	// Den inkluderer felt som behøves for SAF tilgangsmodell og visningsmodell.
	// Aliasnavn kan ikke være lengre enn 30 tegn i Oracle 12c r1.
	static String dokumentoversiktBrukerSql(DokumentoversiktBrukerFilter dokumentoversiktBrukerFilter, List<String> cteAliases) {
		return "WITH journalpostid_psak AS\n" +
