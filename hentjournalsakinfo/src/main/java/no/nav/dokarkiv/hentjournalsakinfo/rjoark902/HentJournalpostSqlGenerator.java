...
final class HentJournalpostSqlGenerator {
	...
	// Spørringen henter en journalpost gitt journalpostId/eksternReferanseId parameteren
	...
	static String journalpostIdWhereClause() {
		return """
	...
	static String eksternReferanseIdWhereClause() {
		return """
				WHERE j.kanal_referanse_id = :eksternReferanseId
				ORDER BY dokumenter_tilknyttetsom ASC, dokumenter_jprelasjonid ASC
				""";
	}
}
