...
public class FinnJournalpostSqlGeneratorTest {
	...
	public void shouldGenerateFinnJournalposterSql() {
		...
		String sql = FinnJournalpostSqlGenerator.finnJournalposterSql(journalpostFilter, Arrays.asList("gsaker", "psaker"), "", false);
		assertThat(sql, equalToCompressingWhiteSpace(
				"WITH psaksaker AS\n" +
						...
						"ORDER BY journalpostid DESC, dokumenter_tilknyttetsom ASC, dokumenter_jprelasjonid ASC, dokumenter_varianter_variantf"
