...
import no.nav.tjeneste.virksomhet.behandlejournal.v2.informasjon.behandlejournal.Journaldistribusjon;
...
public class BehandleJournalCommonDataUtil {
	...
	protected static final String REFERANSEKODE = ReferanseTypeCode.OVERSETTELSE.name();
