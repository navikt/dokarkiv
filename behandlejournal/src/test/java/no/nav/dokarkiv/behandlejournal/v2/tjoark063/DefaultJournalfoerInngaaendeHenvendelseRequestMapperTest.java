...
public class DefaultJournalfoerInngaaendeHenvendelseRequestMapperTest {
	...
	@InjectMocks
	private DefaultJournalfoerInngaaendeHenvendelseRequestMapper requestMapper;

	private JournalfoerInngaaendeHenvendelseRequest wsRequest;
	private no.nav.dokarkiv.behandlejournal.v2.tjoark063.JournalfoerInngaaendeHenvendelseRequest domainRequest;
