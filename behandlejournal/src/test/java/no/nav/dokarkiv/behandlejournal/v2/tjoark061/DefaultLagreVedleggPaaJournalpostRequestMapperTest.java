 ...
 */
public class DefaultLagreVedleggPaaJournalpostRequestMapperTest {
	...
	private void assertRequests(
			no.nav.dokarkiv.behandlejournal.v2.tjoark061.LagreVedleggPaaJournalpostRequest domainRequest) throws Exception {
