 ...
 */
public class JournalfoerUtgaaendeHenvendelseIT extends AbstractBehandleJournalV2Itest {
	...
	public void setUp() throws Exception {
		...
		response = behandleJournalProvider.journalfoerUtgaaendeHenvendelse(request);
