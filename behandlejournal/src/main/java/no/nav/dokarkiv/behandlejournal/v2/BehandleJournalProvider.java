...
public class BehandleJournalProvider implements BehandleJournalV2 {
	...
	private final BehandleJournalServiceBi behandleJournalServiceBi;
	private final BehandleJournalFaultInfoPopulator behandleJournalFaultInfoPopulator;
	private final ArkiverUstrukturertKravRequestMapper arkiverUstrukturertKravRequestMapper;
	private final ArkiverUstrukturertKravResponseMapper arkiverUstrukturertKravResponseMapper;
	private final LagreVedleggPaaJournalpostRequestMapper lagreVedleggPaaJournalpostRequestMapper;
	private final LagreVedleggPaaJournalpostResponseMapper lagreVedleggPaaJournalpostResponseMapper;
	private final FerdigstillDokumentopplastingRequestMapper ferdigstillDokumentopplastingRequestMapper;
	private final JournalfoerInngaaendeHenvendelseRequestMapper journalfoerInngaaendeHenvendelseMedHoveddokumentRequestMapper;
	private final JournalfoerInngaaendeHenvendelseResponseMapper journalfoerInngaaendeHenvendelseMedHoveddokumentResponseMapper;
	private final JournalfoerUtgaaendeHenvendelseRequestMapper journalfoerUtgaaendeHenvendelseMedHoveddokumentRequestMapper;
	private final JournalfoerUtgaaendeHenvendelseResponseMapper journalfoerUtgaaendeHenvendelseResponseMapper;
	private final JournalfoerNotatHenvendelseRequestMapper journalfoerNotatHenvendelseRequestMapper;
	private final JournalfoerNotatHenvendelseResponseMapper journalfoerNotatHenvendelseResponseMapper;

	public BehandleJournalProvider(BehandleJournalServiceBi behandleJournalServiceBi, BehandleJournalFaultInfoPopulator behandleJournalFaultInfoPopulator, ArkiverUstrukturertKravRequestMapper arkiverUstrukturertKravRequestMapper, ArkiverUstrukturertKravResponseMapper arkiverUstrukturertKravResponseMapper, LagreVedleggPaaJournalpostRequestMapper lagreVedleggPaaJournalpostRequestMapper, LagreVedleggPaaJournalpostResponseMapper lagreVedleggPaaJournalpostResponseMapper, FerdigstillDokumentopplastingRequestMapper ferdigstillDokumentopplastingRequestMapper, JournalfoerInngaaendeHenvendelseRequestMapper journalfoerInngaaendeHenvendelseMedHoveddokumentRequestMapper, JournalfoerInngaaendeHenvendelseResponseMapper journalfoerInngaaendeHenvendelseMedHoveddokumentResponseMapper, JournalfoerUtgaaendeHenvendelseRequestMapper journalfoerUtgaaendeHenvendelseMedHoveddokumentRequestMapper, JournalfoerUtgaaendeHenvendelseResponseMapper journalfoerUtgaaendeHenvendelseResponseMapper, JournalfoerNotatHenvendelseRequestMapper journalfoerNotatHenvendelseRequestMapper, JournalfoerNotatHenvendelseResponseMapper journalfoerNotatHenvendelseResponseMapper) {
		this.behandleJournalServiceBi = behandleJournalServiceBi;
		this.behandleJournalFaultInfoPopulator = behandleJournalFaultInfoPopulator;
