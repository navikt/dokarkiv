...
public class DefaultJournalfoerUtgaaendeHenvendelseRequestMapper implements
	...
	public DefaultJournalfoerUtgaaendeHenvendelseRequestMapper(SporingMapper sporingMapper) {
	...
	public JournalfoerUtgaaendeHenvendelseRequest map(
		...
		no.nav.tjeneste.virksomhet.behandlejournal.v2.informasjon.journalfoerutgaaendehenvendelse.Journalpost wsJournalpost = wsRequest.getJournalpost();
